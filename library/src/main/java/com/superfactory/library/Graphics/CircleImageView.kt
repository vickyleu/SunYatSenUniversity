...
class CircleImageView : ImageView {
    ...
    private var mCircleBackgroundColor = DEFAULT_circleBackgroundColor
    ...
    @JvmOverloads constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        // Look for deprecated fill_color if circleBackgroundColor is not set
    ...
    companion object {
        ...
        private val DEFAULT_circleBackgroundColor = Color.TRANSPARENT
